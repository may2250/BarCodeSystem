...
public final class Intents {
  ...
  public static final class Scan {
    ...
    /**
     * Optional parameter to specify the id of the com.example.administrator.retrofitsample.camera from which to recognize barcodes.
     * Overrides the default com.example.administrator.retrofitsample.camera that would otherwise would have been selected.
